...
var path = require('shims/titanium/path')
  , utils = require('./utils');
...
var tty = require('shims/titanium/tty')
  , diff = require('shims/titanium/diff')
  , ms = require('../ms');
...
var EventEmitter = require('shims/titanium/events').EventEmitter
  , debug = require('shims/titanium/debug')('mocha:runnable')
...
var EventEmitter = require('shims/titanium/events').EventEmitter
  , debug = require('shims/titanium/debug')('mocha:runner')
  , Test = require('./test')
  , utils = require('./utils')
  , filter = utils.filter
  , keys = utils.keys
...
}); // module: shims/titanium/diff.js

require.register("shims/titanium/events.js", function(module, exports, require){
...
}); // module: shims/titanium/events.js

require.register("shims/titanium/fs.js", function(module, exports, require){

}); // module: shims/titanium/fs.js

require.register("shims/titanium/path.js", function(module, exports, require){

}); // module: shims/titanium/path.js

require.register("shims/titanium/progress.js", function(module, exports, require){
...
}); // module: shims/titanium/progress.js
...
var EventEmitter = require('shims/titanium/events').EventEmitter
  , debug = require('shims/titanium/debug')('mocha:suite')
  , milliseconds = require('./ms')
  , utils = require('./utils')
  , Hook = require('./hook');
...
var fs = require('shims/titanium/fs')
  , path = require('shims/titanium/path')
  , join = path.join
  , debug = require('shims/titanium/debug')('mocha:watch');
